...
expName = 'Permanence_RO'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mettapham/Downloads/HOMES_RankOrder-Permanence/Permanence_RO_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='Welcome to the Permanence Rank Ordering Task',
    font='Open Sans',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text="In this task, you will look at 14 items and rank them on how often you think the item's position to change in an environment. 1 representing the item most likely to be moved and 14 representing the item least likely to be moved.\n\nPress SPACE to begin",
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
image1 = visual.ImageStim(
    win=win,
    name='image1', 
    image='images_RO_Perm/Landmark1.png', mask=None, anchor='center',
...
image2 = visual.ImageStim(
    win=win,
    name='image2', 
    image='images_RO_Perm/Landmark2.png', mask=None, anchor='center',
...
image3 = visual.ImageStim(
    win=win,
    name='image3', 
    image='images_RO_Perm/Landmark3.png', mask=None, anchor='center',
...
image4 = visual.ImageStim(
    win=win,
    name='image4', 
    image='images_RO_Perm/Landmark4.png', mask=None, anchor='center',
    ori=0.0, pos=(.25,.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image5 = visual.ImageStim(
    win=win,
    name='image5', 
    image='images_RO_Perm/Landmark5.png', mask=None, anchor='center',
    ori=0.0, pos=(.5,.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image6 = visual.ImageStim(
    win=win,
    name='image6', 
    image='images_RO_Perm/Landmark6.png', mask=None, anchor='center',
...
image7 = visual.ImageStim(
    win=win,
    name='image7', 
    image='images_RO_Perm/Landmark7.png', mask=None, anchor='center',
...
image8 = visual.ImageStim(
    win=win,
    name='image8', 
    image='images_RO_Perm/Landmark8.png', mask=None, anchor='center',
...
image9 = visual.ImageStim(
    win=win,
    name='image9', 
    image='images_RO_Perm/Landmark9.png', mask=None, anchor='center',
    ori=0.0, pos=(.25,0), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image10 = visual.ImageStim(
    win=win,
    name='image10', 
    image='images_RO_Perm/Landmark10.png', mask=None, anchor='center',
    ori=0.0, pos=(.5,0), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image11 = visual.ImageStim(
    win=win,
    name='image11', 
    image='images_RO_Perm/Landmark11.png', mask=None, anchor='center',
    ori=0.0, pos=(-.5,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image12 = visual.ImageStim(
    win=win,
    name='image12', 
    image='images_RO_Perm/Landmark12.png', mask=None, anchor='center',
    ori=0.0, pos=(-.25,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image13 = visual.ImageStim(
    win=win,
    name='image13', 
    image='images_RO_Perm/Landmark13.png', mask=None, anchor='center',
    ori=0.0, pos=(0,-.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image14 = visual.ImageStim(
    win=win,
    name='image14', 
    image='images_RO_Perm/Landmark14.png', mask=None, anchor='center',
    ori=0.0, pos=(.25, -.3), size=(.2,.2),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Thank you for participating in the Permanence Rank Ordering Task!',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
